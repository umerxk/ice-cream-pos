...
export default function DashTable({ details, text, dateData }: any) {
  ...
  return (
    <div>
      {dateData?.searchedDate && <DataCard dateData={dateData} />}
      <CustomerData totalClients={fltData.length} dateData={dateData} />
      {!!fltData.length &&
